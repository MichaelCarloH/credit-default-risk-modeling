...
def generate_research(company_name, country):
    ...
    Always assume that the company is still operating. Assume that you do not have the actual financial info or balance sheet of the company, and that this research is all based on publicly-available information. is All output should be in English. Put your answer in JSON format.\n\n
