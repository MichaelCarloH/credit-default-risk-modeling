...
def generate_research(company_name, country):
    ...
    Always assume that the company is still operating. All output should be in English. Put your answer in JSON format.\n\n

    If you do not have enough information to answer the question, do not make up information. Instead, say "I do not have enough information to answer the question."  and do not output a JSON. \n\n
